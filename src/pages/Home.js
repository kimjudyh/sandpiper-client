  ...
  return (
    <div className="container home-header">
      ...
      <div className="home-info">
        ...
        <span>
          <img src={process.env.PUBLIC_URL + '/readme_images/mobile-profile.png'} height='500' />   <img src={process.env.PUBLIC_URL + '/readme_images/mobile-birding-session.png'} height='500' />
        </span>
        <Link to={'/register'}><h3>Sign Up</h3></Link>
      </div>
      <div className="home-info">
        ...
        <span>
          <img src={process.env.PUBLIC_URL + '/readme_images/mobile-birding-session-share.png'} height='500' />   <img src={process.env.PUBLIC_URL + '/readme_images/mobile-birding-session-map.png'} height='500' />
        </span>
        <Link to={'/register'}><h3>Sign Up</h3></Link>
      </div>
      <div className="home-info">
        ...
        <span>
          <img src={process.env.PUBLIC_URL + '/readme_images/mobile-bird.png'} height='500' />   <img src={process.env.PUBLIC_URL + '/readme_images/mobile-photos-sorted-bird.png'} height='500'></img>
        </span>
        <Link to={'/register'}><h3>Sign Up</h3></Link>
      </div>
      <div className="home-info">
